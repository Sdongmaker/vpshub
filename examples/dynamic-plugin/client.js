    ...
    return h('div', { className: 'vpsh-wrap' },
      ...
      h('div', { className: 'vpsh-form' },
        ...
        h('div', { className: 'vpsh-form-row' },
          ...
          h('input', { className: 'vpsh-input', value: form.label, onChange: set('label'), placeholder: tr('namePh') }),
        ),
        h('div', { className: 'vpsh-form-row' },
        ...
        h('div', { className: 'vpsh-form-row' },
          ...
          h('input', { className: 'vpsh-input', value: form.identityFile, onChange: set('identityFile'), placeholder: tr('keyPathPh') }),
        ),
        h('div', { className: 'vpsh-form-row' },
          h('label', null, tr('pasteKey')),
          h('textarea', { className: 'vpsh-input', value: form.identityKeyContent, onChange: set('identityKeyContent'), placeholder: tr('pasteKeyPh'), rows: 4, style: { fontFamily: 'monospace', fontSize: 11, resize: 'vertical' } }),
        ),
        h('div', { className: 'vpsh-form-row' },
          h('label', null, tr('password')),
          h('input', { className: 'vpsh-input', type: 'password', value: form.password, onChange: set('password'), placeholder: tr('passwordPh') }),
        ),
        h('div', { className: 'vpsh-form-row' },
          h('label', null, tr('jumpHost')),
          h('input', { className: 'vpsh-input', value: form.jumpHost, onChange: set('jumpHost'), placeholder: tr('jumpHostPh') }),
        ),
        h('div', { className: 'vpsh-form-row' },
          h('label', null, tr('proxyCmd')),
          h('input', { className: 'vpsh-input', value: form.proxyCommand, onChange: set('proxyCommand'), placeholder: tr('proxyCmdPh') }),
        ),
        h('div', { className: 'vpsh-form-row' },
          h('label', null, tr('tags')),
          h('input', { className: 'vpsh-input', value: form.tags, onChange: set('tags'), placeholder: tr('tagsPh') }),
        ),
        h('div', { className: 'vpsh-form-row' },
